                    ...
                    <ul class="menu-bar">
                        ...
                        <div id="dropdown2" class="dropdown">
                            <ul role="menu">
                                ...
                                <li role="menuitem">
                                    <a class="dropdown-link" href="./ADMIN/tambahabsensi.php">Tambah Data</a>
                                </li>
                                <li role="menuitem">
                                    <a class="dropdown-link" href="./ADMIN/lihatabsensi.php">Lihat Data</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li><a class="nav-link" href="./ADMIN/galeri.php">Galeri</a></li>
