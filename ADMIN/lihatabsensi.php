...
<head>
    ...
    <style>
        ...
        .form-container6 label {
            margin-right: 10px;
            font-size: 16px;
            
        }
        .form-container6 input, .form-container6 button {
            font-size: 16px;
            padding: 5px 10px;
            margin-right: 10px;
        ...
        .form-container6 button {
            background-color: #4CAF50;
            color: white;
            border: none;
            cursor: pointer;
        }
        .form-container6 button:hover {
            ...
            <div class="nav-end">
                <div class="right-container">
                    ...
                    <a href="#" button type="submit" class="btn btn-primary"
                        onclick="confirmLogout()">Keluar</button></a>
                </div>
    ...
    <div class="container6">
        <div class="form-container6">
            <form action="laporan.php" method="GET">
                ...
                <input type="month" id="periode" name="periode" value="<?php echo date('Y-m'); ?>">
                <button type="submit" >Download Laporan Kehadiran</button>
            </form>
        </div>
    </div>

        <canvas id="myChart" style="width:100%;max-width:120vh;margin-bottom:3vh;"></canvas>
